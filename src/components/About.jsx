    ...
    return (
        <div className='namemain'>
            ...
            <div className='abtcnt'>
                <h1 className='t1'>Hey.what's up?Hello!👋</h1>
                <p className='myself'>I'm<b> Aman Gupta</b>  - a <u>full stack web developer</u> studnet who tries to blend the best of the design and functionalities into web apps.
                ...
                <p className='myself'>  I am a tech enthusiast who lives in the tech realm,I try to discover new technologies and
                    new innovation in the tech industry.I like working on new technologies and love to figure out there scopes for the social causes for the mankind.
                </p>
            </div>
